...
Open http://localhost:5000, connect MAL (and optionally AniList), then go to the Sync tab.
...
Connect your AniList account via the "Connect AniList" button. Two-way sync requires both accounts.
